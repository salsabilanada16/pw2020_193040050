...
<body id="services" class="inner_page" data-spy="scroll" data-target="#navbar-wd" data-offset="98" style="background-image: url(../img/Background/bg3.jpg)">
    ...
    <header class="top-header">
        <nav class="navbar header-nav navbar-expand-lg">
            <div class="container-fluid">
                <a class="navbar-brand" href="more.php"><img src="../img/Logo/logo1.png" alt="image" style="width: 50%;"></a>
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbar-wd">
                    <ul class="navbar-nav">
                        ...
                        <li><a class="nav-link" href="elements.php">About</a></li>
                        <li><a class="nav-link" href="elements.php">Collections</a></li>
                        <li><a class="nav-link" href="more.php">Trendy</a></li>
                        <li><a class="nav-link" href="elements.php">Most Wanted</a></li>
                        <li><a class="nav-link" href="elements.php">Limited</a></li>
                    </ul>
                </div>
            </div>
        </nav>
    ...
    <div class="section layout_padding">
        <div class="container">
            ...
            <div class="row margin-top_30">
                <?php foreach ($style as $sty) : ?>
                    <div class="col-sm-12 col-md-3">
                        <div class="service_blog">
                            <div class="service_icons">
                                <img src="../img/More/<?= $sty["Gambar"]; ?>" style="display: block; margin-left: auto; margin-right: auto; width: 100%;">
                            </div>
                        </div>
                    </div>
                <?php endforeach; ?>
