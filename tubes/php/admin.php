...
<body id="home" data-spy="scroll" data-target="#navbar-wd" data-offset="98" class="scrollspy" style="background-image: url(../img/Background/bg6.jpg)">
    ...
    <header class="top-header">
        <nav class="navbar header-nav navbar-expand-lg">
            <div class="container-fluid">
                <a class="navbar-brand" href="admin.php"><img src="../img/Logo/logo1.png" alt="image" style="width: 50%;"></a>
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbar-wd">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li><a class="nav-link" href="tambah.php" style="font-size: 220%; margin-top: -15px;">+</a></li>
                        <li><a class="nav-link active" href="logout.php" style="background: palevioletred; color:#fff;">Bye!</a>
                        </li>
                        <li>
    ...
    <div class="container1">
        <section id="collections" class="section lb">
                            ...
                            <?php foreach ($pakaian as $pkn) : ?>
                                <div class="col-sm-6 col-md-4">
                                    <div class="service_blog">
                                        ...
                                        <div class="card-action" style="margin-left: 20%;">
    ...
    <!-- Trendy -->
    <section id="trendy" class="section lb">
        <div class="section layout_padding">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
    ...
    <footer class="footer-box">
        <div class="container" style="height: 25%;">
            <div class="row">
                <div class="col-md-12 margin-bottom_20">
